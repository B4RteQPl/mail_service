...
class ActiveCampaignResponderMail implements MailProviderResponderInterface
{
    ...
    public function getMailingLists(): array
    {
        ...
        foreach ($this->response['lists'] as $group) {
            $mailingList = new MailingList($group['id'], $group['name'], ActiveCampaignMailProvider::MAIL_PROVIDER_TYPE);
    ...
    public function getVerifiedSubscriberFromSearchResult(SubscriberDraft|SubscriberVerified $subscriber): SubscriberVerified
    {
