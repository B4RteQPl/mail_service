...
class MailChimpResponderMail implements MailProviderResponderInterface
{
    ...
    public function getMailingLists(): array
    {
        ...
        foreach ($this->response['lists'] as $group) {
            $mailingList = new MailingList($group['id'], $group['name'], MailChimpMailProvider::MAIL_PROVIDER_TYPE);
