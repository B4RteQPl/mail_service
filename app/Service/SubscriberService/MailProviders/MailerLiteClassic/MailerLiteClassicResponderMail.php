...
class MailerLiteClassicResponderMail implements MailProviderResponderInterface
{
    ...
    public function getMailingLists(): array
    {
        ...
        foreach ($this->response as $group) {
            $mailingList = new MailingList($group['id'], $group['name'], MailerLiteClassicMailProvider::MAIL_PROVIDER_TYPE);
    ...
    public function getVerifiedSubscriberAfterDeleteFromMailingList(SubscriberDraft|SubscriberVerified $subscriber, MailingList $mailingList): SubscriberVerified
    {
